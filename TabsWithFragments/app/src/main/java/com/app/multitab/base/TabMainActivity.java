...
import com.app.multitab.tabA.TabAFirstFragment;
import com.app.multitab.tabB.TabBFirstFragment;
      ...
      public void onTabChanged(String tabId) {
        ...
        if(mStacks.get(tabId).size() == 0){
          ...
          if(tabId.equals(Constants.TAB_A)){
            pushFragments(tabId, new TabAFirstFragment(), false,true);
          }else if(tabId.equals(Constants.TAB_B)){
            pushFragments(tabId, new TabBFirstFragment(), false,true);
          }
        }else {
          /*
